...
<!--[if gt IE 9]><!--><html class="no-js" lang="en"><!--<![endif]-->
    <head>
        ...
        <title>Harris Dermatology</title>
    ...
    <body id="page">
        ...
        <ul class="cb-slideshow">
            <li>
            	<span>Image 01</span>
            		<div>
            			<h3>Harris Dermatology</h3>
            		</div>
            </li>
            <li><span>Image 02</span><div><h3>Harris Dermatology</h3></div></li>
            <li><span>Image 03</span><div><h3>Harris Dermatology</h3></div></li>
            <li><span>Image 04</span><div><h3>Harris Dermatology</h3></div></li>
            <li><span>Image 05</span><div><h3>Harris Dermatology</h3></div></li>
            <li><span>Image 06</span><div><h3>Harris Dermatology</h3></div></li>
        </ul>
        <div class="container">
            
            <header>
                <h1> <span>Harris Dermatology</span></h1>
